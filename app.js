...
// تحديد أبعاد الشاشة لتناسب شاشة الجوال.
canvas.width = window.innerWidth;
canvas.height = window.innerHeight;
// استخدام context 2D للرسم.
let context = canvas.getContext('2d');
// مجموعات الألعاب النارية والجسيمات.
let fireworks = [], particles = [];
// إحداثيات الماوس.
let mouseX, mouseY;
// متغير للتحقق مما إذا كان الماوس مضغوطًا.
let isMouseDown = false;
// اللون الابتدائي.
let hue = 120;
// تتبع عدد الدقائق منذ إطلاق الألعاب النارية تلقائيًا.
let ticksSinceFireworkAutomated = 0;
// تتبع عدد الدقائق منذ إطلاق الألعاب النارية يدويًا.
...
// استخدام requestAnimationFrame للحفاظ على حلقات الرسوم المتدفقة.
...
// الحصول على رقم عشوائي ضمن النطاق المحدد.
...
// تتبع النقر على الماوس.
canvas.addEventListener('touchstart', (e) => {
	e.preventDefault();
	isMouseDown = true;
});

// تتبع رفع النقر عن الماوس.
